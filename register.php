...
<section id="title-header">
  <div class="title">  
     <img class="logo" src="cap.png">Grade 2 <br>Inteacher
      <br>Programmer : Pamela
      <p class="subtitle"> Inteacher For ICT and English</p> 
  </div>
</section> 
...
?>
   <footer style="height: 100px;border-top:1px solid #ddd;padding: 5px;background-color: blue; color:#fff;">
              <p align="left">&copy; Inteacher For ICT and English</p>
     </footer>
 </section>
