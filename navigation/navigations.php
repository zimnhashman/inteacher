...
<title><?php echo $title;?> | Grade </title>
...
<section id="title-header">
  <div class="title">  
     <img class="logo" src="hit.jpg">HIT  <br>INTELLIGENT TEACHER
      <br>
      <p class="subtitle"></p> 
  </div>
</section>  
<section id="navigation">
  <div id="mySidenav" class="sidenav">
    ...
    <a href="<?php echo web_root; ?>index.php?q=about" id="about">Recommendations<i class="fa fa-info-circle pull-right"></i></a>  
